...
import com.example.ce1.model.HemanthAddress;
...
@RestController
public class HemanthAddressController {
    ...
    public ResponseEntity<HemanthAddress> postMethodName(@RequestBody HemanthAddress address,@PathVariable int id) {
